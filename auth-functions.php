                        ...
                        <div class="flex">
                            ...
                            if ($show_refund): ?>
                                <button
                                    ...
                                    data-journey-group-id="<?php echo esc_attr(get_post_meta(get_the_ID(), 'journey_group_id', true)); ?>"
                                    data-partner-id="<?php echo esc_attr(get_post_meta(get_the_ID(), 'partner_id', true)); ?>"
