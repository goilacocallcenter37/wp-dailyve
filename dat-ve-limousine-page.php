 ...
 * Template Name: Page Đặt Vé Limousine
...
$seatType = get_query_var('seatType');
...
<div class="content-area">
    ...
    <div class="container online-booking__search-form">
        ...
        <div id="Info" class="w-100" style="color: var(--fs-color-success);">
            <div style="display: <?= !$isBooking ? 'none' : 'block'; ?>;" class="pb3 tc-l tl f4 w-100 ttn">Vé xe <?= $seatText; ?> từ <b id="fromName"></b> Đến <b id="toName"></b></div>
        </div>
        <div id="searchForm" class="w-100 tl shadow-search">
            <form class=" w-100" action="/dat-ve-limousine-truc-tuyen" autocomplete="off">
                <div class="vxr-widget__wrapper autocomplete cf w-100 flex flex-wrap justify-center items-center" style="border-radius: 6px; background-color: #ffffff;">
                    <div class="w-100 w-20 relative item-search">
                        ...
                        <input type="hidden" name="seatType" value="<?= $seatType ?? 0; ?>" />
    ...
    <div class="container">
        ...
        <div class="online-booking-page__content">
            ...
            <div class="vivu-providers-header">
                ...
                <div class="vivu-author">
                    ...
                    <div class="vivu-author__img">
                        ...
                        <img src="/wp-content/uploads/assets/images/logo-icon-f2.png"
            ...
            <?php if (isset($data['data']) && isset($dataStatictis['data']['companies']['data'])) { ?>

                <div class="total-vexe-route">

                    <div>Vé xe <?= $seatText; ?> <span id="count-dataxe"><?= count($dataStatictis['data']['companies']['data']); ?></span> nhà xe từ <?= $data['data']['area']['from']['name']; ?> đi <?= $data['data']['area']['to']['name']; ?>:</div>

                    <div> <?= $data['data']['total']; ?> chuyến mỗi ngày</div>

                </div>

            <?php } ?>

            <div class="main-vexe-content" is-company-page="0" is-limousine-page="1" seat-type="<?= $seatType; ?>">
                                                ...
                                                <div class="provider-details">
                                                    ...
                                                    <div class="provider-details__tabs width-tab">
                                                        ...
                                                        <div id="pickup-dropoff-points-tab-<?= $item['route']['schedules'][0]['tripCode']; ?>"
                                                            ...
                                                            <div class="header-content">Các mốc thời gian đón, trả bên dưới là thời gian dự kiến. Lịch này có thể thay đổi tùy tình hình thưc tế.</div>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="not-fount-trip-container">
                                    ...
                                    <div class="not__found__content">
                                        ...
                                        <div class="label">Xin lỗi bạn vì sự bất tiện này. Dailyve sẽ cập nhật ngay khi có thông tin xe hoạt động trên tuyến đường <br>
                ...
                ?>
                    ...
                    <div class="fillter-company-main" style="width: 100%;">

                        <div class="list-route-trip-container list-company-limousine-container" data-from="<?= $from; ?>" data-to="<?= $to; ?>">
...
<div class="bai-viet-tuyen-duong"><?php echo do_shortcode("[baivietTuyenduongLimousine]"); ?></div>
...
<script>
    ...
    jQuery(document).ready(function($) {
        ...
        if (jQuery('.main-vexe-content').length > 0) {
...
<script>
    ...
    jQuery(document).ready(function($) {
        ...
        var from = jQuery('.list-company-limousine-container').attr('data-from') ?? '';

        var to = jQuery('.list-company-limousine-container').attr('data-to') ?? '';



        <?php if (!$isBooking) { ?>

            jQuery('.total-vexe-route').hide();

            const randomParam = new Date().getTime();

            jQuery.ajax({

                url: '<?= admin_url('admin-ajax.php') ?>?rand=' + randomParam,

                method: 'POST',

                data: {

                    action: 'get_company_limousine_route_data',

                    nonce: '<?= wp_create_nonce("ams_nhaxe_limousine") ?>',
                ...
                <li class="blog-post o-media">
                    ...
                    jQuery('.list-company-limousine-container').html(skeloader)
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        jQuery('.total-vexe-route').show();

                        // Generate the list dynamically

                        const listContainer = document.createElement('ul');

                        listContainer.className = 'online-booking-page__provider-list';



                        response.data.forEach((item) => {

                            const tripCode = item.route.schedules[0].tripCode;

                            const utilities = JSON.stringify(item.route.utilities);
        ...
        <li class="online-booking-page__provider-list__item" 
            ...
            <div class="online-booking-page__provider-list__item__img">
                ...
                <img
                    ...
                    src="${item.meta.thumbnail_url ? item.meta.thumbnail_url : '/wp-content/uploads/assets/images/logo-icon-f2.png'}"
            ...
            <div class="online-booking-page__provider-list__item__info w-42p">

                <div class="online-booking-page__provider-list__item__bus-name-info">

                    <h2 style="font-size: 17px;">${item.company.displayName}</h2>

                </div>

                <div class="rating-content">

                    <p>${item.company.ratings.overall}</p>

                    <img src="/wp-content/uploads/assets/images/star.svg" alt="Icon Start" />

                    <span>(${item.company.ratings.comments})</span>

                </div>

                <div class="online-booking-page__provider-list__item__bus-type-info" style="margin-top: 8px;">

                    ${item.meta.vehicle_type?.length > 0 ? item.meta.vehicle_type?.map((type) => `<p style="margin-bottom: 0.2em; font-size: 13.5px;">${type}</p>`).join("") : ''}

                </div>

                <div class="online-booking-page__provider-list__item__route-info">

                    <div class="online-booking-page__provider-list__item__route-info__item"><strong class="online-booking-page__provider-list__item__route-info__item-place" style="color: #000;">${item.from?.name}</strong></div>

                    <div class="online-booking-page__provider-list__item__route-info__travel-time">${totalTimeRoute(item.route.schedules[0].pickupDate, item.route.schedules[0].arrivalTime)}</div>

                    <div class="online-booking-page__provider-list__item__route-info__item online-booking-page__provider-list__item__route-info__item--ct"><strong class="online-booking-page__provider-list__item__route-info__item-place" style="color: #000;">${item.to?.name}</strong></div>

                </div>

            </div>

            <div class="online-booking-page__provider-list__item__handle w-38p">

                <div class="online-booking-page__provider-list__item__price review-first" style="position: relative;">

                    ${item.route.notificationStr ? `<img src="/wp-content/uploads/assets/images/double-quotes.svg" alt="double quotes icon"> <p class="content-review">${item.route.notificationStr}</p>` : ""}

                </div>

                <div class="online-booking-page__provider-list__item__btns">

                    <button data-idnhaxe="${item.company.id}" data-load="0"

                                    data-tripid="${tripCode}"

                                    class="online-booking-page__provider-list__item__details-btn"

                                    style="font-family: 'OpenSans-Bold';">Thông tin chi tiết</button>

                    <button data-link="?date="

                                    data-datepicker="dailyve_calendar_route_${item.company.id}"

                                    class="online-booking-page__provider-list__item__price-btn booking-dailyve-route"

                                    style="background: var(--primary-color);">

                                    Xem giá

                                    <input type="text" class="dailyve_calendar" name="dailyve_calendar_route_${item.company.id}" />
            ...
            <div class="online-booking-page__provider-list__details-tab"
                            ...
                            id="detail-tab-${tripCode}">

                            <div class="provider-details">

                                <ul class="provider-details__nav">

                                    <li data-tab="images-tab-${tripCode}"

                                        class="active">Hình ảnh</li>

                                    <li

                                        data-tab="convenience-tab-${tripCode}">

                                        Tiện ích</li>

                                    <li

                                        data-tab="ratings-tab-${tripCode}">

                                        Đánh giá</li>

                                    <li

                                        data-tab="pickup-dropoff-points-tab-${tripCode}">

                                        Điểm đón, trả</li>

                                    <li

                                        data-tab="policy-tab-${tripCode}">
                                ...
                                <div class="provider-details__tabs width-tab">
                                    ...
                                    <div id="images-tab-${tripCode}"

                                        class="provider-details__tab images-tab">

                                        <div class="provider-details__gallery">`

                            if (item.meta?.gallery && item.meta?.gallery?.length > 0) {

                                listItem += `<div class="provider-details__gallery-main">`;

                                item.meta?.gallery.map((g) => {

                                    listItem += ` <div class="provider-details__gallery-main__item">
                                ...
                                item.meta?.gallery.map((g) => {
                                    ...
                                    listItem += `<div class="provider-details__gallery-thumbnails__item">
                                ...
                                listItem += `<p style="text-align: center;"><strong>Dailyve</strong> sẽ sớm cập nhật thông tin nhà xe ${item.company.name} đến quý khách. <br> <a href="tel:19000155">Liên hệ hỗ trợ</a></p>`
                            ...
                            listItem += `</div>
                                    ...
                                    <div id="convenience-tab-${tripCode}"
                                    ...
                                    <div id="pickup-dropoff-points-tab-${tripCode}"
                                    ...
                                    <div id="ratings-tab-${tripCode}"
                                        ...
                                        <div class="rating-tab__comments-list-pagination"
                                            ...
                                            id="comment-pagination-${tripCode}">
                        ...
                        jQuery('#count-dataxe').text(response.data?.length);

                        jQuery('.o-vertical-spacing--l').remove();

                        jQuery('.list-company-limousine-container').html(listContainer);
    ...
    function totalTimeRoute(thoiGianBatDau, thoiGianKetThuc) {
        ...
        const timestampBatDau = parseDateTime(thoiGianBatDau).getTime();

        const timestampKetThuc = parseDateTime(thoiGianKetThuc).getTime();



        const khoangThoiGian = timestampKetThuc - timestampBatDau;



        const soGio = Math.floor(khoangThoiGian / 3600000); // 1 giờ = 3600000 ms

        const soPhut = Math.floor((khoangThoiGian % 3600000) / 60000); // 1 phút = 60000 ms
